...
2. Open this template folder and run from the Bruin panel:
   ...
   - Use the Bruin panel to run `validate`, `run`, and see rendered code (`at this stage it will fail since not every configuration fields have been updated so update it now or later `)
